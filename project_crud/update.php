...
?>
 ...
 <form action="<?php echo update_form ?>" class="text-bg-dark p-5 m-5" method="POST">

 <input type="hidden" name="token" value="<?php echo base64_encode($user_id) ?>">
 <div class="mb-3">
   <label for="exampleInputEmail1" class="form-label">NAME</label>
   <input type="text" value="<?php echo $row["user_name"];  ?>" name="user_name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  ...
  <div class="mb-3">
   ...
   <input type="password" value="<?php echo base64_decode($row["ptoken"]); ?>" name="pswd" class="form-control" id="exampleInputPassword1">
  </div>
